      ...
      <div className="space-y-3">
        <button type="button" className={socialClass}>
          <svg viewBox="0 0 48 48" className="h-6 w-6" aria-hidden>
            <path fill="#4285F4" d="M45 24c0-1.6-.1-2.7-.4-4H24v7.5h12c-.2 2-1.6 5-4.5 7l6.9 5.3C42.5 36.1 45 30.6 45 24z" />
            <path fill="#34A853" d="M24 46c6 0 11-2 14.7-5.4l-6.9-5.4c-1.9 1.3-4.4 2.2-7.8 2.2-6 0-11-4-12.8-9.4l-7.1 5.5C7.8 41 15.3 46 24 46z" />
            <path fill="#FBBC05" d="M11.2 28c-.5-1.4-.7-2.9-.7-4s.3-2.6.7-4L4 14.5C2.5 17.4 2 20.6 2 24s.5 6.6 2 9.5l7.2-5.5z" />
            <path fill="#EA4335" d="M24 10.4c3.3 0 5.6 1.4 6.9 2.6l5.9-5.8C33 3.9 28.5 2 24 2 15.3 2 7.8 7 4 14.5l7.2 5.5C13 14.4 18 10.4 24 10.4z" />
          </svg>
