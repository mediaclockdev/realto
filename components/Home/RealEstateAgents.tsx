...
const partners = [raywhite,bengiang,century,rw,sp,mcgrath,savills ,wiseberry,prd,richard, ljhooker,firstnational ,belle ,ronis,harcourts,quest,combined,professional,infinity,aria,bobb,pace,rainehorne,elder];
